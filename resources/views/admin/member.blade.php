...
<div class="container-fluid" id="page">
    <div class="card card-default">
        <div class="card-header" id="page-buku">{{__('Pengelolaan Member')}}</div>
        <div class="card-body">
                ...
                <table id="table-data" class="table table-hover">
                    ...
                    <tbody>
                        ...
                        <tr class="text-center">
                            ...
                            <td>
                                <form action="member/nonaktif" method="post">
                                    @csrf
                                    @method('patch')
...
function aktifasiMember(id){
            ...
            Swal.fire({
                ...
                text: "Kamu Akan Menonaktifkan Akun "+id,
                icon: 'question',
